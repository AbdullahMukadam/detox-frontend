        ...
        >
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                <MaterialIcons name="person-outline" size={20} color={COLORS.textGray} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
          ...
          <View style={styles.footer}>
            ...
            <View style={styles.signupContainer}>
              ...
              <TouchableOpacity>
                {/* Ensure this route points to your login screen */}
...
const styles = StyleSheet.create({
  ...
  loginButton: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    marginTop: 12, // Slightly more margin for signup
